...
def fetch_ir_remote():
    ...
    while True:
        ...
        time.sleep(0.5)  # Reduced polling rate to avoid overwhelming the ESP32
...
# Start the fetch IR remote in a background thread
...
# Variable for skipping frames to reduce processing load
frame_skip = 2
frame_count = 0
